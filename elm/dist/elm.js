...
var $author$project$Main$SetCamera = function (a) {
	return {$: 'SetCamera', a: a};
};
...
var $author$project$Proto$Camera$Internals_$defaultProto__Camera__OpenCameraResponse = {message: ''};
...
var $author$project$Proto$Camera$Internals_$decodeProto__Camera__OpenCameraResponse = A2(
	$eriktim$elm_protocol_buffers$Protobuf$Decode$message,
	$author$project$Proto$Camera$Internals_$defaultProto__Camera__OpenCameraResponse,
	_List_fromArray(
		[
			A3(
...
var $author$project$Proto$Camera$decodeOpenCameraResponse = $author$project$Proto$Camera$Internals_$decodeProto__Camera__OpenCameraResponse;
...
var $author$project$Proto$Camera$Internals_$encodeProto__Camera__OpenCameraRequest = function (value) {
...
var $author$project$Main$OpenCamera = function (a) {
	return {$: 'OpenCamera', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$OpenCamera('test_path'))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Open Camera')
					])),
				A2(
				$elm$core$Maybe$withDefault,
				$elm$html$Html$text(''),
