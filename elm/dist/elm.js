...
var $author$project$Main$init = function (_v0) {
	...
	return _Utils_Tuple2(
		{availableCameraList: _List_Nil, cameraH: $elm$core$Maybe$Nothing, error: $elm$core$Maybe$Nothing},
		initCameraHandler);
};
				...
				if (_v1.$ === 'Just') {
					...
					return _Utils_Tuple2(
						...
						$GlobalWebIndex$cmd_extra$Cmd$Extra$perform(
							$author$project$Main$FatalException('no camera handler')));
				}
