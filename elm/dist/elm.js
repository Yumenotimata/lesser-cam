...
var $author$project$CameraHandler$CameraHandler = F2(
	function (ws, name) {
		return {name: name, ws: ws};
	});
...
var $author$project$WebSocket$WebSocket = function (uuid) {
	return {uuid: uuid};
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$WebSocket$decode = A2(
	$elm$json$Json$Decode$map,
	$author$project$WebSocket$WebSocket,
...
var $author$project$WebSocket$encodeOpenWebSocketJson = function (packet) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'url',
				$elm$json$Json$Encode$string(packet.url))
			]));
};
var $author$project$WebSocket$open = function (url) {
	var ws = A2(
		$lobanov$elm_taskport$TaskPort$call,
		{argsEncoder: $author$project$WebSocket$encodeOpenWebSocketJson, _function: 'openWebSocket', valueDecoder: $author$project$WebSocket$decode},
		{url: url});
	return ws;
};
var $author$project$CameraHandler$new = function (_v0) {
	return A2(
		$elm$core$Task$map,
		function (ws) {
			return A2($author$project$CameraHandler$CameraHandler, ws, 'test camera name handler');
		},
		$author$project$WebSocket$open('ws://localhost:8000/ws'));
};
var $author$project$Main$FatalException = function (a) {
	return {$: 'FatalException', a: a};
};
...
var $author$project$Main$unwrapTask = function (task) {
	return A2(
		$elm$core$Task$attempt,
		$elm_community$result_extra$Result$Extra$merge,
		A2(
			$elm$core$Task$mapError,
			A2($elm$core$Basics$composeR, $lobanov$elm_taskport$TaskPort$errorToString, $author$project$Main$FatalException),
			task));
};
var $author$project$Main$init = function (_v0) {
	var initCameraHandler = $author$project$Main$unwrapTask(
		A2(
			$elm$core$Task$map,
...
var $author$project$Main$GotAvailableCameraList = function (a) {
	return {$: 'GotAvailableCameraList', a: a};
};
var $author$project$Main$GotCamera = function (a) {
	return {$: 'GotCamera', a: a};
};
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'uuid',
							$elm$json$Json$Encode$int(packet.uuid))
						])))
			]));
};
var $author$project$WebSocket$SendWebSocketJson = F2(
	function (uuid, message) {
		return {message: message, uuid: uuid};
	});
var $author$project$WebSocket$decodeSendWebSocketJson = A3(
	$elm$json$Json$Decode$map2,
	$author$project$WebSocket$SendWebSocketJson,
	A2($elm$json$Json$Decode$field, 'uuid', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'message', $elm$json$Json$Decode$value));
var $author$project$WebSocket$encodeSendWebSocketJson = function (packet) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'uuid',
				$elm$json$Json$Encode$int(packet.uuid)),
				_Utils_Tuple2('message', packet.message)
			]));
};
var $author$project$WebSocket$sendWebSocket = F2(
	function (ws, message) {
		return A2(
			$lobanov$elm_taskport$TaskPort$call,
			{argsEncoder: $author$project$WebSocket$encodeSendWebSocketJson, _function: 'sendWebSocket', valueDecoder: $author$project$WebSocket$decodeSendWebSocketJson},
			{message: message, uuid: ws.uuid});
	});
var $author$project$CameraHandler$getCameraImageQuery = F2(
	function (ws, uuid) {
		return A2(
			$author$project$WebSocket$sendWebSocket,
			ws,
			$author$project$CameraHandler$encodeGetCameraImageJson(
				{uuid: uuid}));
	});
var $author$project$CameraHandler$getCameraImage = F2(
	function (camH, camera) {
		return A2(
			$elm$core$Task$map,
			A2(
				...
				$elm$json$Json$Decode$decodeValue($author$project$CameraHandler$decodeGetCameraImageResponseJson)),
			A2($author$project$CameraHandler$getCameraImageQuery, camH.ws, camera.uuid));
	});
var $author$project$CameraHandler$GetCameraListResponse = function (cameras) {
	return {cameras: cameras};
};
var $author$project$CameraHandler$decodeGetCameraListResponse = A2(
	$elm$json$Json$Decode$map,
	$author$project$CameraHandler$GetCameraListResponse,
	A2(
		$elm$json$Json$Decode$field,
		'CameraList',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$CameraHandler$encodeGetCameraListJson = function (packet) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$CameraHandler$getCameraListQuery = function (ws) {
	return A2(
		$author$project$WebSocket$sendWebSocket,
		ws,
		$author$project$CameraHandler$encodeGetCameraListJson(
			{}));
};
var $author$project$CameraHandler$getCameraList = function (camH) {
	return A2(
		$elm$core$Task$map,
		function (q) {
			return A2($elm$json$Json$Decode$decodeValue, $author$project$CameraHandler$decodeGetCameraListResponse, q.message);
		},
		$author$project$CameraHandler$getCameraListQuery(camH.ws));
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$CameraHandler$OpenCameraResponseJson = function (uuid) {
	return {uuid: uuid};
};
var $author$project$CameraHandler$decodeOpenCameraResponseJson = A2(
	$elm$json$Json$Decode$map,
	$author$project$CameraHandler$OpenCameraResponseJson,
	A2($elm$json$Json$Decode$field, 'Camera', $elm$json$Json$Decode$int));
...
var $author$project$CameraHandler$encodeOpenCameraRequestJson = function (packet) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'name',
							$elm$json$Json$Encode$string(packet.name))
						])))
			]));
};
var $author$project$CameraHandler$openCameraQuery = F2(
	function (ws, name) {
		return A2(
			$author$project$WebSocket$sendWebSocket,
			ws,
			$author$project$CameraHandler$encodeOpenCameraRequestJson(
				{name: name}));
	});
var $author$project$CameraHandler$open = F2(
	function (camH, name) {
		return A2(
			$elm$core$Task$map,
			$elm$core$Result$map(
			...
			A2(
				...
				A2(
					...
					$elm$json$Json$Decode$decodeValue($author$project$CameraHandler$decodeOpenCameraResponseJson)),
				A2($author$project$CameraHandler$openCameraQuery, camH.ws, name)));
	});
				...
				switch (msg.$) {
					...
					case 'InitCameraH':
						return _Utils_Tuple2(
							...
							$GlobalWebIndex$cmd_extra$Cmd$Extra$perform(
								$author$project$Main$Unreachable('camera handler is already initialized')));
